package com.springtoken.springboot_token.web;

import com.springtoken.springboot_token.Data.AccessToken;
import com.springtoken.springboot_token.Data.ApiResponse;
import com.springtoken.springboot_token.Data.TokenInfo;
import com.springtoken.springboot_token.Data.UserInfo;
import com.springtoken.springboot_token.aspect.NotRepeatSubmit;
import com.springtoken.springboot_token.util.MD5Util;
import com.springtoken.springboot_token.Data.AppInfo;
...
//        log.info(signature);
    ...
    public ApiResponse<UserInfo> userToken(String username, String password) {
        ...
        String pwd = password + 'f';
        String passwordMD5 = MD5Util.encode(pwd);
        //Assert.isTrue(passwordMD5.equals(), "密码错误");
